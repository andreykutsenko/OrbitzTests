...
def verify_flight(context, city_from, city_to, start_trip_week, back_trip_week):
    context.app.results_page.verify_flight_result(city_from, city_to, start_trip_week, back_trip_week)